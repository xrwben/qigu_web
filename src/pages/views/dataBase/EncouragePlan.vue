  ...
  <div id="EncouragePlan">
    ...
    <div class="nav">
      ...
      <div class="dropDown" v-show="showDropDown">
        ...
        <p>按类型筛选</p>
        <p>
          <input type="radio" id="type1" v-model="form.type" value="1"><label for="type1">股权激励计划书</label>
        </p>
        <p>
          <input type="radio" id="type2" v-model="form.type" value="2"><label for="type2">董事会决议</label>
        </p>
        <p>
          <input type="radio" id="type3" v-model="form.type" value="3"><label for="type3">执行董事决议</label>
        </p>
        <p>
          <input type="radio" id="type4" v-model="form.type" value="4"><label for="type4">股东会决议</label>
        </p>
        <p>
          <input type="radio" id="type5" v-model="form.type" value="5"><label for="type5">股东大会决议</label>
        </p>
        <div class="btns">
  ...
  export default {
    ...
    methods: {
      ...
      getDatas () {
        this.axios({
          method: 'GET',
          url: '/keygood/web/stimulatedocument/findMapByLike',
          params: {
